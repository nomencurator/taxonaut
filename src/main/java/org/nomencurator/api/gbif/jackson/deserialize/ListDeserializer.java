/*
 * ListDesrializert.java:  a deserizaliser for List
 *
...
/**
 * {@code ListDeserializer} provides a {@link JsonDeserializer} for {@link List},
 *
 * @version 	09 Feb. 2020
...
public class ListDeserializer<T> extends JsonDeserializer<List<T>> {
	...
	List<T> set = mapper.readValue(jp, new TypeReference<List<T>>() {});
	return set;
    }
}
