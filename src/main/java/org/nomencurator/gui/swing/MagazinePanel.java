/*
 * MagazinePanel.java:  a java based GUI for Nomencurator
 *
...
/**
 * {@code MagazinePanel} provides {@code CitationPanel}
 ...
 */
public class MagazinePanel
    extends ArticlePanel
{
    private static final long serialVersionUID = 5365940295316621974L;

    public MagazinePanel(CitationModel model,
			    Locale locale)
    {
	super(model, locale);
    }
