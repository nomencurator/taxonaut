/*
 * BasicDualTreeUI.java:  a TreeUI with node alignment between
 * trees
 *
...
/**
 * <CODE>BasicDualTreeUI</CODE> provides an inteface definition of  {@code Flippable} <code>TreeUI</code>
 *
 * @version 	03 May. 2022
 * @author 	Nozomi `James' Ytow
 */
public class BasicDualTreeUI
    extends BasicTreeUI
{
    /**
     * {@inheritDoc}
     */
    public static BasicDualTreeUI createUI(JComponent c)
    {
        return new BasicDualTreeUI();
    }
    protected DualTree dualTree;

    protected BasicDualTreeUI()
    {
	super();
	System.out.println("BasicDualTreeUI()");
    }
