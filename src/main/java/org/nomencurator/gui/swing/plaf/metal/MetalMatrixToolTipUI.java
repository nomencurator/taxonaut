...
import org.nomencurator.gui.swing.plaf.MatrixToolTipAdaptor;
 ...
 */
public class MetalMatrixToolTipUI
    extends MetalToolTipUI
{
    static MetalMatrixToolTipUI sharedInstance = 
	new MetalMatrixToolTipUI();
    ...
    {
	MatrixToolTipAdaptor.paint(g, c,
    ...
    {
	return MatrixToolTipAdaptor.getPreferredSize(c,
						     ((JToolTip)c).getTipText(),
						     getAcceleratorString());
    }
}
