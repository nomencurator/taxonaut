...
/**
 * <CODE>MetalAlignerTreeUI</CODE> provides a <code>TreeUI</code> capable to align
 * nodes between trees
 *
 * @version 	4 Nov. 2014
 * @author 	Nozomi `James' Ytow
 */
public class MetalAlignerTreeUI
    extends MetalTreeUI
    implements Alignable, Aligner//, AlignableTreeUI
{
    protected Aligner aligner;

    public MetalAlignerTreeUI()
    {
	super();
