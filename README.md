...
accessible by GBIF Species API.  Current version is [3.1.5](https://github.com/nomencurator/taxonaut/releases/tag/v3.1.6).
[Executable jar file](https://github.com/nomencurator/taxonaut/releases/download/v3.1.6/Taxonaut-3.1.6-jar-with-dependencies.jar) is available to try on any Java 8 environment including Linux, Mac OS X, Solaris and Windows.
Download the jar file and double click it, or if it does not work, execute java from the command line by typing
```
java -jar Taxonaut-3.1.6-jar-with-dependencies.jar
```
